...
// ======================================================
constexpr double NTC_NOMINAL_R = 78500.0;  // rezystancja przy 25°C
constexpr double NTC_NOMINAL_T = 25.0;      // temperatura nominalna
constexpr double NTC_BETA      = 4100.0;    // współczynnik beta
constexpr double R_PULLUP      = 98000.0;  // rezystor w dzielniku
constexpr int    NTC_ADC_MAX       = 4095;        // Rozdzielczość ADC ESP32 (12-bit)
constexpr int    NTC_SAMPLES       = 100;          // Liczba próbek do uśrednienia
...
constexpr float NTC_FILTER_ALPHA = 0.91f;
// ======================================================
// KONFIGURACJA ADC ESP32 DLA NTC
// ======================================================
constexpr adc_attenuation_t NTC_ADC_ATTENUATION = ADC_11db;
constexpr int NTC_ADC_RESOLUTION = 12;

// ======================================================
// KALIBRACJA NTC Z POMIARÓW (ADC -> temperatura)
// ======================================================

constexpr double NTC_A4 =  9.87706295e-11;
constexpr double NTC_A3 = -3.27628714e-07;
constexpr double NTC_A2 =  4.13650975e-04;
constexpr double NTC_A1 = -2.73316975e-01;
constexpr double NTC_A0 =  1.33620289e+02;
...
// --- WiFi / Web ---
constexpr const char* CFG_WIFI_HOSTNAME = "wedzarnia";
